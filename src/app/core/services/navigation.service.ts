    ...
    },
    {
      ...
      dropdown: [
        ...
        },
        {
          ...
          description: [
            'Мы заботимся о безопасной перевозке вашего груза и максимально снижаем ваши имущественные' +
              ' риски, предлагая услугу по страхованию груза.',
            'Нашим партнером является компания ПАО «Страховая акционерная компания «ЭНЕРГОГАРАНТ».',
          ],
    ...
    },
    {
      ...
      dropdown: [
        ...
        },
        {
          ...
          description: [
            'Тарифы указаны только для филиалов «Баскурьер».',
            'Чтобы узнать стоимость отправления из других населенных пунктов, свяжитесь с оператором.',
          ],
        ...
        },
        {
          link: 'info/storage',
          name: 'Хранение груза',
          description: 'Условия и правила хранения грузов на складах',
