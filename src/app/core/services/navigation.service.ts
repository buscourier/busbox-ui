  ...
  private readonly navigationConfig: NavigationItem[] = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        {
          link: 'services/airport-delivery',
      ...
      dropdown: [
        ...
        },
        {
          ...
          page: {
            ...
            description: ['Тарифы отличаются в зависимости от города отправления.'],
          },
          seo: {
        ...
        {
          link: 'info/storage',
          name: 'Хранение грузов в пунктах выдачи',
          icon: '@tui.warehouse',
          badge: { text: 'Важная информация', color: 'red' },
          page: {
            title: 'Хранение грузов в пунктах выдачи',
        ...
        },
        {
          ...
          page: {
            title: 'Документы',
            description: ['Необходимые документы для работы с баскурьер'],
          },
          seo: {
