...
Сервис позволяет произвести предварительный расчет доставки посылки, оформить заявку на доставку и отслеживать стадии доставки посылки.

## Зависимости проекта

- https://timeweb.cloud - хостинг проекта
- https://doppler.com - сервис для управления переменными окружения ...
- https://hub.docker.com - сервис для хранения образов проекта созданных докером,
  образ загружается на хостинг и там запускается
- https://imagekit.io (логин: admin@busbox.guru) - сервис для хранения картинок
